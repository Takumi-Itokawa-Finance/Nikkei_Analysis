...
cells.append(code([
    ...
    "nikkei_raw = yf.download('^N225', period=PERIOD, interval='1d', progress=False, auto_adjust=True)\n",
    "nikkei_raw.index = pd.to_datetime(nikkei_raw.index)\n",
    "\n",
