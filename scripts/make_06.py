...
cells.append(code([
    ...
    "\n",
    "# unstack() sorts columns by Unicode code point (場 < 始 < 終),\n",
    "# which differs from the intended order (始値, 終値, 場中).\n",
    "# Reindex to match x-axis label order before extracting .values.\n",
    "target_order = list(TARGET_LABELS.values())  # ['始値リターン', '終値リターン', '場中リターン']\n",
