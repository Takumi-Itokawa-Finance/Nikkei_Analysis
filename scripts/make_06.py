...
cells.append(code([
    ...
    "tlabels = list(TARGET_LABELS.values())  # Japanese labels used as Target index\n",
    "x = np.arange(len(tlabels))\n",
    "w = 0.35\n",
    "bar1 = ax.bar(x - w/2, pivot.loc['Idea 1 (Rule-based)', tlabels],\n",
    "              w, label='Idea 1 (Rule-based)', color='steelblue', alpha=0.85)\n",
    "bar2 = ax.bar(x + w/2, pivot.loc['Idea 2 (XGBoost)',   tlabels],\n",
